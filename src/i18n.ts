...
export const mobileTranslations: Record<Locale, { controlsSize: string; medium: string; large: string; xlarge: string; swipeHint: string; controlsHint: string }> = {
  'pt-BR': { controlsSize: 'Tamanho dos controles', medium: 'Médio', large: 'Grande', xlarge: 'Muito grande', swipeHint: 'Você também pode arrastar o dedo em qualquer parte livre da tela.', controlsHint: 'ARRASTAR ou SETAS' },
  en: { controlsSize: 'Control size', medium: 'Medium', large: 'Large', xlarge: 'Extra large', swipeHint: 'You can also swipe anywhere on the open game screen.', controlsHint: 'SWIPE or ARROWS' },
  es: { controlsSize: 'Tamaño de controles', medium: 'Mediano', large: 'Grande', xlarge: 'Muy grande', swipeHint: 'También puedes deslizar el dedo en cualquier parte libre de la pantalla.', controlsHint: 'DESLIZAR o FLECHAS' },
  fr: { controlsSize: 'Taille des commandes', medium: 'Moyenne', large: 'Grande', xlarge: 'Très grande', swipeHint: "Vous pouvez aussi glisser le doigt sur toute zone libre de l'écran.", controlsHint: 'GLISSER ou FLÈCHES' },
  de: { controlsSize: 'Steuerungsgröße', medium: 'Mittel', large: 'Groß', xlarge: 'Sehr groß', swipeHint: 'Du kannst auch über einen freien Bereich des Spielfelds wischen.', controlsHint: 'WISCHEN oder PFEILE' },
  it: { controlsSize: 'Dimensione controlli', medium: 'Media', large: 'Grande', xlarge: 'Molto grande', swipeHint: 'Puoi anche scorrere il dito in qualsiasi area libera dello schermo.', controlsHint: 'SCORRI o FRECCE' },
  ja: { controlsSize: '操作ボタンのサイズ', medium: '中', large: '大', xlarge: '特大', swipeHint: 'ゲーム画面の空いている場所をスワイプして操作できます。', controlsHint: 'スワイプ または 矢印' },
  ko: { controlsSize: '컨트롤 크기', medium: '중간', large: '크게', xlarge: '매우 크게', swipeHint: '게임 화면의 빈 곳을 스와이프해서도 조작할 수 있습니다.', controlsHint: '스와이프 또는 화살표' },
  'zh-CN': { controlsSize: '控制按钮大小', medium: '中', large: '大', xlarge: '超大', swipeHint: '也可以在游戏画面的空白区域滑动来控制方向。', controlsHint: '滑动或方向键' },
  ru: { controlsSize: 'Размер управления', medium: 'Средний', large: 'Большой', xlarge: 'Очень большой', swipeHint: 'Также можно провести пальцем по свободной области игрового экрана.', controlsHint: 'СВАЙП или СТРЕЛКИ' },
};
