...
export interface Translation {
  ...
  shareText: string; ad: string; levelNames: string[];
}
...
export const translations: Record<Locale, Translation> = {
  'pt-BR': {
    ...
    shareX: 'COMPARTILHAR NO X', settings: 'CONFIGURAÇÕES', language: 'Idioma', quality: 'Qualidade gráfica', sound: 'Sons',
    low: 'Baixa', medium: 'Média', high: 'Alta', enabled: 'Ligados', disabled: 'Desligados', close: 'SALVAR E FECHAR',
    shareText: 'Fiz {score} pontos no Snake 3D! Você consegue superar?', ad: 'ANÚNCIO',
  ...
  en: {
    ...
    shareX: 'SHARE ON X', settings: 'SETTINGS', language: 'Language', quality: 'Graphics quality', sound: 'Sound',
    low: 'Low', medium: 'Medium', high: 'High', enabled: 'On', disabled: 'Off', close: 'SAVE AND CLOSE',
    shareText: 'I scored {score} points in Snake 3D! Can you beat me?', ad: 'ADVERTISEMENT',
  ...
  es: {
    ...
    shareX: 'COMPARTIR EN X', settings: 'AJUSTES', language: 'Idioma', quality: 'Calidad gráfica', sound: 'Sonido',
    low: 'Baja', medium: 'Media', high: 'Alta', enabled: 'Activado', disabled: 'Desactivado', close: 'GUARDAR Y CERRAR',
    shareText: '¡Hice {score} puntos en Snake 3D! ¿Puedes superarme?', ad: 'ANUNCIO',
  ...
  fr: {
    ...
    shareX: 'PARTAGER SUR X', settings: 'PARAMÈTRES', language: 'Langue', quality: 'Qualité graphique', sound: 'Son',
    low: 'Basse', medium: 'Moyenne', high: 'Haute', enabled: 'Activé', disabled: 'Désactivé', close: 'ENREGISTRER ET FERMER',
    shareText: "J'ai marqué {score} points à Snake 3D ! Pouvez-vous me battre ?", ad: 'PUBLICITÉ',
  ...
  de: {
    ...
    shareX: 'AUF X TEILEN', settings: 'EINSTELLUNGEN', language: 'Sprache', quality: 'Grafikqualität', sound: 'Ton',
    low: 'Niedrig', medium: 'Mittel', high: 'Hoch', enabled: 'An', disabled: 'Aus', close: 'SPEICHERN UND SCHLIESSEN',
    shareText: 'Ich habe {score} Punkte in Snake 3D! Schaffst du mehr?', ad: 'WERBUNG',
  ...
  it: {
    ...
    shareX: 'CONDIVIDI SU X', settings: 'IMPOSTAZIONI', language: 'Lingua', quality: 'Qualità grafica', sound: 'Suono',
    low: 'Bassa', medium: 'Media', high: 'Alta', enabled: 'Attivo', disabled: 'Disattivo', close: 'SALVA E CHIUDI',
    shareText: 'Ho fatto {score} punti a Snake 3D! Riesci a battermi?', ad: 'PUBBLICITÀ',
  ...
  ja: {
    ...
    shareX: 'Xで共有', settings: '設定', language: '言語', quality: '画質', sound: 'サウンド',
    low: '低', medium: '中', high: '高', enabled: 'オン', disabled: 'オフ', close: '保存して閉じる',
    shareText: 'Snake 3Dで{score}点を獲得！超えられる？', ad: '広告',
  ...
  ko: {
    ...
    shareX: 'X에 공유', settings: '설정', language: '언어', quality: '그래픽 품질', sound: '사운드',
    low: '낮음', medium: '중간', high: '높음', enabled: '켜짐', disabled: '꺼짐', close: '저장하고 닫기',
    shareText: 'Snake 3D에서 {score}점! 이 기록을 깰 수 있나요?', ad: '광고',
  ...
  'zh-CN': {
    ...
    shareX: '分享到 X', settings: '设置', language: '语言', quality: '画面质量', sound: '声音',
    low: '低', medium: '中', high: '高', enabled: '开启', disabled: '关闭', close: '保存并关闭',
    shareText: '我在 Snake 3D 中获得了 {score} 分！你能超过吗？', ad: '广告',
  ...
  ru: {
    ...
    shareX: 'ПОДЕЛИТЬСЯ В X', settings: 'НАСТРОЙКИ', language: 'Язык', quality: 'Качество графики', sound: 'Звук',
    low: 'Низкое', medium: 'Среднее', high: 'Высокое', enabled: 'Вкл.', disabled: 'Выкл.', close: 'СОХРАНИТЬ И ЗАКРЫТЬ',
    shareText: 'Я набрал {score} очков в Snake 3D! Сможешь больше?', ad: 'РЕКЛАМА',
